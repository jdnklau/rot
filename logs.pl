...
log_win(Who) :-
  ...
  rot(instance(rot,[Rot,Rot_rate|_])), % algorithm instance #1
  rot(instance(blau,[Blau,Blau_rate|_])), % algorithm instance #2
  % create log file name
  atomics_to_string(['logs/log',win,Blau,Blau_rate,vs,Rot,Rot_rate],'_',Logfile),
